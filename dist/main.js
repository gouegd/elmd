...
var _gouegd$elmd$Main$fullGithub = _elm_lang$core$Native_Utils.update(
			...
			case 'ToggleGithubMode':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							fullGithubMode: _elm_lang$core$Basics$not(model.fullGithubMode)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _gouegd$elmd$Main$Model = F3(
	function (a, b, c) {
		return {text: a, fullGithubMode: b, mdl: c};
	});
var _gouegd$elmd$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _gouegd$elmd$Main$ToggleGithubMode = {ctor: 'ToggleGithubMode'};
var _gouegd$elmd$Main$Entry = function (a) {
	return {ctor: 'Entry', _0: a};
};
var _gouegd$elmd$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _gouegd$elmd$Main$main === 'undefined' ? null : _gouegd$elmd$Main$main);
